...
const Footer = () => {
  return (
      <div className="">
        <footer className="bg-[#101727] footer sm:footer-horizontal text-base-content p-10">
          <nav>
            <p className="font-extrabold text-white text-2xl">DigiTools</p>
            <p className="text-white text-[16px]">Premium digital tools for creators, <br/> professionals, and businesses. <br/> Work smarter with our suite of powerful tools.</p>
          </nav>
          <nav>
            <h6 className="text-white footer-title">Product</h6>
          ...
          <nav>
            ...
            <a className="text-white link link-hover">About</a>
            <a className="text-white link link-hover">Blog</a>
            <a className="text-white link link-hover">Careers</a>
            <a className="text-white link link-hover">Press</a>
          </nav>
          <nav>
            <h6 className="text-white footer-title">Resources</h6>
          ...
          <nav>
              <p className="text-white footer-title">Social links</p>
              <div className="flex gap-3">
              <a className="link link-hover p-2 bg-white rounded-full">
                <svg
        ...
        <footer className="footer py-10 bg-[#101727] text-base-content px-10  flex flex-col md:flex-row lg:flex-row justify-between items-center">
