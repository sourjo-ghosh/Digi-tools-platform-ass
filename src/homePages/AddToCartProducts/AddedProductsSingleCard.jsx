...
const AddedProductsSingleCard = ({ data, SelectedCart, setSelectedCart }) => {
  ...
  return (
    <div className="flex justify-between items-center border border-gray-200 bg-gray-200 p-4 rounded-2xl mb-3">
      ...
      <button
        ...
        className="px-4 py-2 rounded-xl border bg-white border-gray-300 text-sm text-gray-500 hover:bg-red-50 hover:text-red-500 hover:border-red-300 transition-all"
      >
        Remove
      </button>
    </div>
